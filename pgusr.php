...
<div class="navbar" >
    ...
    <?php
        ...
        echo"<div align='center'><FONT size=+5 color=#B7B9B5 style='Bold Font'><u>Paying Guest List</u></font></img></div><br>";
        include_once('connectPg.php');
        $qry0 = "SELECT * FROM `tbusr` ";
        ...
        while($row = mysqli_fetch_array($result))
        {
            ...
            echo "<td width=20% height=30%>"; echo $row["pgCod"]; echo "</td>";
            echo "<td width=20% height=30%>"; echo $row["usrDoj"]; echo "</td>";
            echo "<td width=20% height=30%>";echo $row["usrNam"]; echo "</td>";
            echo "<td width=20% height=30%>"; echo $row["usrAdr"]; echo "</td>";
            echo "<td width=20% height=30%>"; echo $row["usrOcp"]; echo "</td>";
            echo"</tr>";
